...
class PopularCategorySection2Widget extends ConsumerStatefulWidget {
  // Hardcoded for Section 2
  ...
  const PopularCategorySection2Widget({
    super.key,
    this.titleOverride,
    this.showTitle = true,
  ...
  @override
  ConsumerState<PopularCategorySection2Widget> createState() => _PopularCategorySection2WidgetState();
}

class _PopularCategorySection2WidgetState extends ConsumerState<PopularCategorySection2Widget> {
  bool _expanded = true;

  @override
  Widget build(BuildContext context) {
    // Use dedicated Section 2 provider for complete isolation
    final categoriesAsync = ref.watch(popularCategorySection2Provider);
    ...
    return categoriesAsync.when(
      ...
      error: (error, stackTrace) => Center(
        child: AppErrorWidget(
          ...
          onRetry: () => ref.refresh(popularCategorySection2Provider),
        ),
      ),
    );
  }
