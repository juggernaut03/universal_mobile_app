...
class PopularCategorySection3Widget extends ConsumerStatefulWidget {
  ...
  const PopularCategorySection3Widget({
    Key? key,
    this.titleOverride,
    this.showTitle = true,
  ...
  @override
  ConsumerState<PopularCategorySection3Widget> createState() => _PopularCategorySection3WidgetState();
}

class _PopularCategorySection3WidgetState extends ConsumerState<PopularCategorySection3Widget> {
  bool _expanded = true;

  @override
  Widget build(BuildContext context) {
    // Use dedicated Section 3 provider for complete isolation
    final categoriesAsync = ref.watch(popularCategorySection3Provider);
    ...
    return categoriesAsync.when(
      ...
      error: (error, stackTrace) => Center(
        child: AppErrorWidget(
          ...
          onRetry: () => ref.refresh(popularCategorySection3Provider),
        ),
      ),
    );
  }
  ...
  Widget _buildCategoryCard(BuildContext context, dynamic category) {
    // Same implementation as existing widget
