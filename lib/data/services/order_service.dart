...
class OrderService {
  ...
  // Modified confirmOrder method to create new entries rather than overwriting
...
Future<OrderConfirmationResponse> confirmOrder({
  ...
  try {
    ...
    final Map<String, dynamic> requestBody = {
      "temp_order_id": tempOrderId,  // Keep consistent device identifier
      "project_code": ApiConstants.projectCode,
      "customer_cart_key": uniqueOrderCartKey,  // Use NEW unique key for this order
      "store_code": storeCode,
      "device_id": deviceId,  // Keep consistent device identifier
      ...
      "order_status": "Order Confirmed",  // Always "Order Confirmed" for new orders
